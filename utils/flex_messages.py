...
def create_help_flex():
    ...
    games_info = [
        {"emoji": "🧠", "name": "ذكاء", "desc": "أسئلة منطقية ورياضية"},
        {"emoji": "🧍‍♂️", "name": "تحليل", "desc": "تحليل الشخصية"},
        {"emoji": "🤔", "name": "خمن", "desc": "تخمين الأشياء"},
        {"emoji": "🔠", "name": "ترتيب", "desc": "ترتيب الحروف"},
        {"emoji": "📝", "name": "كلمات", "desc": "تكوين كلمات"},
        {"emoji": "⚡", "name": "أسرع", "desc": "سرعة الكتابة"},
        {"emoji": "🎮", "name": "لعبة", "desc": "إنسان حيوان نبات"},
        {"emoji": "❤️", "name": "توافق", "desc": "نسبة التوافق"},
        {"emoji": "💬", "name": "صراحة", "desc": "أسئلة صراحة"}
    ]
